...
Controlled **foundation cohort** page (`route_id`: `en_foundation_reference_layers`) for **Reference Layer Overview** — COHORT_01_FOUNDATION_GOV. Nine reference layers and anti-duplication rules.
...
Foundation hub slice — internal reference by `route_id` `en_foundation_reference_layers` only; no markdown links in this draft.
