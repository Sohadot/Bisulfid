...
Controlled **foundation cohort** page (`route_id`: `en_foundation_methodology`) for **Corpus Methodology** — COHORT_01_FOUNDATION_GOV. How governed pages are authored, validated, and batched.
