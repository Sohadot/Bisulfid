...
Controlled **foundation cohort** page (`route_id`: `en_foundation_institutional_purpose`) for **Institutional Purpose** — COHORT_01_FOUNDATION_GOV. Why bisulfid.com exists as an institutional reference surface.
...
Foundation hub slice — internal reference by `route_id` `en_foundation_institutional_purpose` only; no markdown links in this draft.
