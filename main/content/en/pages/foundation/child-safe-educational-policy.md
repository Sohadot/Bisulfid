...
Controlled **foundation cohort** page (`route_id`: `en_foundation_child_safe_policy`) for **Child-Safe Educational Policy** — COHORT_01_FOUNDATION_GOV. Educational pages without hazard or experiment instruction.
