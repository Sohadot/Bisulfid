...
Controlled **foundation cohort** page (`route_id`: `en_foundation_claim_policy`) for **Claim Policy Overview** — COHORT_01_FOUNDATION_GOV. How claims are registered, approved, and bounded.
...
Foundation hub slice — internal reference by `route_id` `en_foundation_claim_policy` only; no markdown links in this draft.
