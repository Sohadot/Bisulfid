...
evidence_grade: economic_context_pending
...
Controlled **foundation cohort** page (`route_id`: `en_foundation_economic_institutional_restrictions`) for **Economic and Institutional Claim Restrictions** — COHORT_01_FOUNDATION_GOV. Blocks on unsupported market and institutional claims.
...
| --- | --- |
| knowledge_reliability_level | L2_draft_cautious |
| evidence_grade | economic_context_pending (governance framing) |
