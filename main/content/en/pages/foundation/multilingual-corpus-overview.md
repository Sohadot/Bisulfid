...
Controlled **foundation cohort** page (`route_id`: `en_foundation_multilingual_overview`) for **Multilingual Corpus Overview** — COHORT_01_FOUNDATION_GOV. Seven language layers and hreflang readiness.
