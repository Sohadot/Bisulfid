...
Controlled **foundation cohort** page (`route_id`: `en_foundation_corpus_status`) for **Corpus Status** — COHORT_01_FOUNDATION_GOV. Current corpus locks and production posture.
...
Foundation hub slice — internal reference by `route_id` `en_foundation_corpus_status` only; no markdown links in this draft.
