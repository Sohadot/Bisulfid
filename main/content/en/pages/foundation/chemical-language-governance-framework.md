...
Controlled **foundation cohort** page (`route_id`: `en_foundation_chemical_language_governance`) for **Chemical-Language Governance Framework** — COHORT_01_FOUNDATION_GOV. Governance of chemical-language meaning across languages.
