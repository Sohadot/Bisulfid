...
Controlled **foundation cohort** page (`route_id`: `en_foundation_audience_layers`) for **Audience Layer Overview** — COHORT_01_FOUNDATION_GOV. Nine audience layers and claim class restrictions.
