...
Controlled **foundation cohort** page (`route_id`: `en_foundation_ai_readable_policy`) for **AI-Readable Reference Policy** — COHORT_01_FOUNDATION_GOV. Machine-readable pages with provenance disclosure.
