...
---
# Sovereign Reference Introduction
...
Controlled **foundation cohort** page (`route_id`: `en_foundation_sovereign_intro`) for **Sovereign Reference Introduction** — COHORT_01_FOUNDATION_GOV. What bisulfid.com is as a governed multilingual reference asset.
...
Foundation hub slice — internal reference by `route_id` `en_foundation_sovereign_intro` only; no markdown links in this draft.
