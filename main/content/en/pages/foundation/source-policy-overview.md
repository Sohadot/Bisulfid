...
Controlled **foundation cohort** page (`route_id`: `en_foundation_source_policy`) for **Source Policy Overview** — COHORT_01_FOUNDATION_GOV. How sources are registered, verified, and bound to pages.
