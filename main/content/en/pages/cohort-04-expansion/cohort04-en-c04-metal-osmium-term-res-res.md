---
route_id: cohort04_en_c04_metal_osmium_term_res_res
inventory_row_id: INV-C04-00387
status: draft
...
locale: en
source_language: en
title: C04 Metal Osmium — Terminology Reference | bisulfid.com
...
---
# C04 Metal Osmium — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_osmium` (metal_sulfide_language)
