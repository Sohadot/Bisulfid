---
route_id: cohort04_en_c04_metal_glaucodot_term_res_res
inventory_row_id: INV-C04-01067
status: draft
...
locale: en
source_language: en
title: C04 Metal Glaucodot — Terminology Reference | bisulfid.com
...
---
# C04 Metal Glaucodot — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_glaucodot` (metal_sulfide_language)
