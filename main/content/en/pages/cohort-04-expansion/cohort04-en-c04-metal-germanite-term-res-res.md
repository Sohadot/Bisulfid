---
route_id: cohort04_en_c04_metal_germanite_term_res_res
inventory_row_id: INV-C04-01027
status: draft
...
locale: en
source_language: en
title: C04 Metal Germanite — Terminology Reference | bisulfid.com
...
---
# C04 Metal Germanite — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_germanite` (metal_sulfide_language)
