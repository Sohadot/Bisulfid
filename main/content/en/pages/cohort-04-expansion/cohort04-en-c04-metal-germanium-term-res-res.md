---
route_id: cohort04_en_c04_metal_germanium_term_res_res
inventory_row_id: INV-C04-00091
status: draft
...
locale: en
source_language: en
title: C04 Metal Germanium — Terminology Reference | bisulfid.com
...
---
# C04 Metal Germanium — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_germanium` (metal_sulfide_language)
