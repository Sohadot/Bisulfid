---
route_id: cohort04_en_c04_metal_chalcocite_term_res_res
inventory_row_id: INV-C04-00867
status: draft
...
locale: en
source_language: en
title: C04 Metal Chalcocite — Terminology Reference | bisulfid.com
...
---
# C04 Metal Chalcocite — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_chalcocite` (metal_sulfide_language)
