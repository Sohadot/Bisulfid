---
route_id: cohort04_en_c04_metal_silver_term_res_res
inventory_row_id: INV-C04-00179
status: draft
...
locale: en
source_language: en
title: C04 Metal Silver — Terminology Reference | bisulfid.com
...
---
# C04 Metal Silver — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_silver` (metal_sulfide_language)
