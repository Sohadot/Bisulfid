---
route_id: cohort04_en_c04_metal_gallium_term_res_res
inventory_row_id: INV-C04-00083
status: draft
...
locale: en
source_language: en
title: C04 Metal Gallium — Terminology Reference | bisulfid.com
...
---
# C04 Metal Gallium — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_gallium` (metal_sulfide_language)
