---
route_id: cohort04_en_c04_metal_cobaltite_term_res_res
inventory_row_id: INV-C04-01011
status: draft
...
locale: en
source_language: en
title: C04 Metal Cobaltite — Terminology Reference | bisulfid.com
...
---
# C04 Metal Cobaltite — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_cobaltite` (metal_sulfide_language)
