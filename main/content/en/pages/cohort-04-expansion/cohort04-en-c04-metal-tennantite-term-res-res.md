---
route_id: cohort04_en_c04_metal_tennantite_term_res_res
inventory_row_id: INV-C04-01099
status: draft
...
locale: en
source_language: en
title: C04 Metal Tennantite — Terminology Reference | bisulfid.com
...
---
# C04 Metal Tennantite — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_tennantite` (metal_sulfide_language)
