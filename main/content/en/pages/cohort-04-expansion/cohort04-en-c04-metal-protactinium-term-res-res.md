---
route_id: cohort04_en_c04_metal_protactinium_term_res_res
inventory_row_id: INV-C04-00483
status: draft
...
locale: en
source_language: en
title: C04 Metal Protactinium — Terminology Reference | bisulfid.com
...
---
# C04 Metal Protactinium — Terminology Reference
...
- Canonical terminology reference surface for `c04_metal_protactinium` (metal_sulfide_language)
