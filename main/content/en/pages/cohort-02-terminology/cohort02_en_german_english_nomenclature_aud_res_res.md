---
route_id: cohort02_en_german_english_nomenclature_aud_res_res
inventory_row_id: INV-C02-00787
status: draft
...
locale: en
source_language: en
title: German English Nomenclature for Researchers | bisulfid.com
template_id: TPL_TERM_CANONICAL_V1
page_type_id: PT_AUDIENCE_EXPLAINER
audience_id: AUD_RESEARCHER
reference_layer_id: REF_RESEARCH
evidence_grade: unsourced_pending
...
---
# German English Nomenclature for Researchers
...
- Audience-layer explainer for `german_english_nomenclature` (Researchers)
...
source_verification, claim_approval, public_route_merge, indexation, multilingual_expansion
...
- `route_id`: `cohort02_en_german_english_nomenclature_term_chem_know` (planning placeholder — not a live link)
