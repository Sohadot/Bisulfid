---
route_id: cohort02_en_thiol_aud_res_res
inventory_row_id: INV-C02-00594
status: draft
...
locale: en
source_language: en
title: Thiol for Researchers | bisulfid.com
...
- Audience-layer explainer for `thiol` (Researchers)
...
- `route_id`: `cohort02_en_thiol_term_chem_know` (planning placeholder — not a live link)
