---
route_id: cohort02_en_procurement_naming_air_res_res
inventory_row_id: INV-C02-00822
status: draft
...
locale: en
source_language: en
title: AI Reference: Procurement Naming | bisulfid.com
...
---
# AI Reference: Procurement Naming
...
- Machine-readable governed record for `procurement_naming`
...
```yaml
term_entity_id: procurement_naming
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
