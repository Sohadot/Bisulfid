---
route_id: cohort02_en_smiles_inchi_terminology_air_res_res
inventory_row_id: INV-C02-00852
status: draft
...
locale: en
source_language: en
title: AI Reference: Smiles Inchi Terminology | bisulfid.com
...
---
# AI Reference: Smiles Inchi Terminology
...
- Machine-readable governed record for `smiles_inchi_terminology`
...
```yaml
term_entity_id: smiles_inchi_terminology
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
