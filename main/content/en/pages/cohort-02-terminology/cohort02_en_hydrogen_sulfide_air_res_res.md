---
route_id: cohort02_en_hydrogen_sulfide_air_res_res
inventory_row_id: INV-C02-00086
status: draft
...
locale: en
source_language: en
title: AI Reference: Hydrogen Sulfide | bisulfid.com
...
- Machine-readable governed record for `hydrogen_sulfide`
...
```yaml
term_entity_id: hydrogen_sulfide
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
