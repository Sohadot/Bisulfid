---
route_id: cohort02_en_calcium_sulfide_air_res_res
inventory_row_id: INV-C02-00345
status: draft
...
locale: en
source_language: en
title: AI Reference: Calcium Sulfide | bisulfid.com
...
- Machine-readable governed record for `calcium_sulfide`
...
```yaml
term_entity_id: calcium_sulfide
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
