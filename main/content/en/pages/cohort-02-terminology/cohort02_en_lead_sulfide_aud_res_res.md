---
route_id: cohort02_en_lead_sulfide_aud_res_res
inventory_row_id: INV-C02-00378
status: draft
...
locale: en
source_language: en
title: Lead Sulfide for Researchers | bisulfid.com
...
- Audience-layer explainer for `lead_sulfide` (Researchers)
...
- `route_id`: `cohort02_en_lead_sulfide_term_chem_know` (planning placeholder — not a live link)
