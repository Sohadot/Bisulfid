---
route_id: cohort02_en_carbon_disulfide_air_res_res
inventory_row_id: INV-C02-00271
status: draft
...
locale: en
source_language: en
title: AI Reference: Carbon Disulfide | bisulfid.com
...
- Machine-readable governed record for `carbon_disulfide`
...
```yaml
term_entity_id: carbon_disulfide
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
