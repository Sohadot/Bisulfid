---
route_id: cohort02_en_sphalerite_aud_res_res
inventory_row_id: INV-C02-00708
status: draft
...
locale: en
source_language: en
title: Sphalerite for Researchers | bisulfid.com
...
- Audience-layer explainer for `sphalerite` (Researchers)
...
- `route_id`: `cohort02_en_sphalerite_term_chem_know` (planning placeholder — not a live link)
