---
route_id: cohort02_en_iupac_sulfide_nomenclature_air_res_res
inventory_row_id: INV-C02-00807
status: draft
...
locale: en
source_language: en
title: AI Reference: Iupac Sulfide Nomenclature | bisulfid.com
...
---
# AI Reference: Iupac Sulfide Nomenclature
...
- Machine-readable governed record for `iupac_sulfide_nomenclature`
...
```yaml
term_entity_id: iupac_sulfide_nomenclature
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
