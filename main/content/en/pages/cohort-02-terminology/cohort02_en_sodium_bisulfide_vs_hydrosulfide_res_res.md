---
route_id: cohort02_en_sodium_bisulfide_vs_hydrosulfide_res_res
inventory_row_id: INV-C02-00884
status: draft
...
locale: en
source_language: en
title: Sodium Bisulfide vs Sodium Hydrosulfide — Difference Reference | bisulfid.com
template_id: TPL_COMPARE_V1
page_type_id: PT_DIFFERENCE_COMPARISON
audience_id: AUD_RESEARCHER
reference_layer_id: REF_RESEARCH
evidence_grade: comparative_boundary
...
---
# Sodium Bisulfide vs Sodium Hydrosulfide — Difference Reference
...
- Comparison intent: Sodium Bisulfide vs Sodium Hydrosulfide
- Mode: technical comparison
...
| --- | --- | --- | --- |
| A | sodium_bisulfide | source_required_unresolved | claim_pending_review |
| B | sodium_hydrosulfide | source_required_unresolved | claim_pending_review |
...
source_verification, claim_approval, public_route_merge, indexation, multilingual_expansion, comparison_boundary_verification
...
- `route_id`: `glossary` (planning placeholder — not a live link)
- `route_id`: `cohort02_en_sodium_bisulfide_term_chem_know` (planning placeholder — not a live link)
- `route_id`: `cohort02_en_sodium_hydrosulfide_term_chem_know` (planning placeholder — not a live link)

No live public URLs. No markdown hyperlinks. Planning references by `route_id` only.

*Non-public COHORT_02 draft — COHORT_02_EN_TERMINOLOGY_SPINE — engine v1.*
