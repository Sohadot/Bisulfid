---
route_id: cohort02_en_sodium_sulfide_aud_res_res
inventory_row_id: INV-C02-00416
status: draft
...
locale: en
source_language: en
title: Sodium Sulfide for Researchers | bisulfid.com
...
---
# Sodium Sulfide for Researchers
...
- Audience-layer explainer for `sodium_sulfide` (Researchers)
...
- `route_id`: `cohort02_en_sodium_sulfide_term_chem_know` (planning placeholder — not a live link)
