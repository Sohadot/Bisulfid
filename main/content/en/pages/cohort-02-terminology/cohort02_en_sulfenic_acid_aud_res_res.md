---
route_id: cohort02_en_sulfenic_acid_aud_res_res
inventory_row_id: INV-C02-00613
status: draft
...
locale: en
source_language: en
title: Sulfenic Acid for Researchers | bisulfid.com
...
- Audience-layer explainer for `sulfenic_acid` (Researchers)
...
- `route_id`: `cohort02_en_sulfenic_acid_term_chem_know` (planning placeholder — not a live link)
