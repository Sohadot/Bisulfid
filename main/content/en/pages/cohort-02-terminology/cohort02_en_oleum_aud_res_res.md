---
route_id: cohort02_en_oleum_aud_res_res
inventory_row_id: INV-C02-00746
status: draft
...
locale: en
source_language: en
title: Oleum for Researchers | bisulfid.com
...
- Audience-layer explainer for `oleum` (Researchers)
...
- `route_id`: `cohort02_en_oleum_term_chem_know` (planning placeholder — not a live link)
