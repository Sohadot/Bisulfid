---
route_id: cohort02_en_molybdenum_disulfide_air_res_res
inventory_row_id: INV-C02-00152
status: draft
...
locale: en
source_language: en
title: AI Reference: Molybdenum Disulfide | bisulfid.com
...
---
# AI Reference: Molybdenum Disulfide
...
- Machine-readable governed record for `molybdenum_disulfide`
...
```yaml
term_entity_id: molybdenum_disulfide
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
