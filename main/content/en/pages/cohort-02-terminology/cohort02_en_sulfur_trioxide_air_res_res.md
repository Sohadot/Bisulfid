---
route_id: cohort02_en_sulfur_trioxide_air_res_res
inventory_row_id: INV-C02-00533
status: draft
...
locale: en
source_language: en
title: AI Reference: Sulfur Trioxide | bisulfid.com
...
- Machine-readable governed record for `sulfur_trioxide`
...
```yaml
term_entity_id: sulfur_trioxide
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
