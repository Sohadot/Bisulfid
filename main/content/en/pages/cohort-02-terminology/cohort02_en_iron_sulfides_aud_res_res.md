---
route_id: cohort02_en_iron_sulfides_aud_res_res
inventory_row_id: INV-C02-00321
status: draft
...
locale: en
source_language: en
title: Iron Sulfides for Researchers | bisulfid.com
...
- Audience-layer explainer for `iron_sulfides` (Researchers)
...
- `route_id`: `cohort02_en_iron_sulfides_term_chem_know` (planning placeholder — not a live link)
