---
route_id: cohort02_en_galena_aud_res_res
inventory_row_id: INV-C02-00689
status: draft
...
locale: en
source_language: en
title: Galena for Researchers | bisulfid.com
...
- Audience-layer explainer for `galena` (Researchers)
...
- `route_id`: `cohort02_en_galena_term_chem_know` (planning placeholder — not a live link)
