---
route_id: cohort02_en_copper_sulfides_air_res_res
inventory_row_id: INV-C02-00307
status: draft
...
locale: en
source_language: en
title: AI Reference: Copper Sulfides | bisulfid.com
...
- Machine-readable governed record for `copper_sulfides`
...
```yaml
term_entity_id: copper_sulfides
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
