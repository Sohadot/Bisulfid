---
route_id: cohort02_en_sulfinic_acid_aud_res_res
inventory_row_id: INV-C02-00632
status: draft
...
locale: en
source_language: en
title: Sulfinic Acid for Researchers | bisulfid.com
...
- Audience-layer explainer for `sulfinic_acid` (Researchers)
...
- `route_id`: `cohort02_en_sulfinic_acid_term_chem_know` (planning placeholder — not a live link)
