---
route_id: cohort02_en_pyrite_aud_res_res
inventory_row_id: INV-C02-00670
status: draft
...
locale: en
source_language: en
title: Pyrite for Researchers | bisulfid.com
...
- Audience-layer explainer for `pyrite` (Researchers)
...
- `route_id`: `cohort02_en_pyrite_term_chem_know` (planning placeholder — not a live link)
