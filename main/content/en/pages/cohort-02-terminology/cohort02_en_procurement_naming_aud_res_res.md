---
route_id: cohort02_en_procurement_naming_aud_res_res
inventory_row_id: INV-C02-00817
status: draft
...
locale: en
source_language: en
title: Procurement Naming for Researchers | bisulfid.com
...
---
# Procurement Naming for Researchers
...
- Audience-layer explainer for `procurement_naming` (Researchers)
...
- `route_id`: `cohort02_en_procurement_naming_term_chem_know` (planning placeholder — not a live link)
