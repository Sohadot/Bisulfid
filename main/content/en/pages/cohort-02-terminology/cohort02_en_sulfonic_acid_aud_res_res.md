---
route_id: cohort02_en_sulfonic_acid_aud_res_res
inventory_row_id: INV-C02-00651
status: draft
...
locale: en
source_language: en
title: Sulfonic Acid for Researchers | bisulfid.com
...
- Audience-layer explainer for `sulfonic_acid` (Researchers)
...
- `route_id`: `cohort02_en_sulfonic_acid_term_chem_know` (planning placeholder — not a live link)
