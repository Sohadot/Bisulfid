---
route_id: cohort02_en_sulfide_anion_aud_res_res
inventory_row_id: INV-C02-00232
status: draft
...
locale: en
source_language: en
title: Sulfide Anion for Researchers | bisulfid.com
...
- Audience-layer explainer for `sulfide_anion` (Researchers)
...
- `route_id`: `cohort02_en_sulfide_anion_term_chem_know` (planning placeholder — not a live link)
