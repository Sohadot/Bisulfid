---
route_id: cohort02_en_bisulfite_disambiguation_air_res_res
inventory_row_id: INV-C02-00186
status: draft
...
locale: en
source_language: en
title: AI Reference: Bisulfite Disambiguation | bisulfid.com
...
---
# AI Reference: Bisulfite Disambiguation
...
- Machine-readable governed record for `bisulfite_disambiguation`
...
```yaml
term_entity_id: bisulfite_disambiguation
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
