---
route_id: cohort02_en_molybdenum_disulfide_mos2_air_res_res
inventory_row_id: INV-C02-00171
status: draft
...
locale: en
source_language: en
title: AI Reference: Molybdenum Disulfide Mos2 | bisulfid.com
...
---
# AI Reference: Molybdenum Disulfide Mos2
...
- Machine-readable governed record for `molybdenum_disulfide_mos2`
...
```yaml
term_entity_id: molybdenum_disulfide_mos2
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
