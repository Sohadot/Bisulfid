---
route_id: cohort02_en_sodium_bisulfide_air_res_res
inventory_row_id: INV-C02-00103
status: draft
...
locale: en
source_language: en
title: AI Reference: Sodium Bisulfide | bisulfid.com
...
- Machine-readable governed record for `sodium_bisulfide`
...
```yaml
term_entity_id: sodium_bisulfide
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
