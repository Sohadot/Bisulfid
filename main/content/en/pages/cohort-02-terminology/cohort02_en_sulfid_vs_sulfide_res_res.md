---
route_id: cohort02_en_sulfid_vs_sulfide_res_res
inventory_row_id: INV-C02-00860
status: draft
...
locale: en
source_language: en
title: Sulfid vs Sulfide — Difference Reference | bisulfid.com
...
---
# Sulfid vs Sulfide — Difference Reference
...
- Comparison intent: Sulfid vs Sulfide
...
| --- | --- | --- | --- |
| A | sulfid | source_required_unresolved | claim_pending_review |
...
- `route_id`: `cohort02_en_sulfid_term_chem_know` (planning placeholder — not a live link)
