---
route_id: cohort02_en_suffix_id_ide_aud_res_res
inventory_row_id: INV-C02-00772
status: draft
...
locale: en
source_language: en
title: Suffix Id Ide for Researchers | bisulfid.com
...
- Audience-layer explainer for `suffix_id_ide` (Researchers)
...
- `route_id`: `cohort02_en_suffix_id_ide_term_chem_know` (planning placeholder — not a live link)
