---
route_id: cohort02_en_cas_registry_language_air_res_res
inventory_row_id: INV-C02-00837
status: draft
...
locale: en
source_language: en
title: AI Reference: Cas Registry Language | bisulfid.com
...
---
# AI Reference: Cas Registry Language
...
- Machine-readable governed record for `cas_registry_language`
...
```yaml
term_entity_id: cas_registry_language
source_posture: source_required_unresolved
claim_posture: claim_pending_review
excluded_claim_classes: ['safety', 'medical', 'market', 'procurement', 'production', 'pricing', 'trade', 'CAGR', 'acquisition', 'operational_handling_guidance']
