---
route_id: cohort02_en_zinc_sulfide_aud_res_res
inventory_row_id: INV-C02-00433
status: draft
...
locale: en
source_language: en
title: Zinc Sulfide for Researchers | bisulfid.com
...
- Audience-layer explainer for `zinc_sulfide` (Researchers)
...
- `route_id`: `cohort02_en_zinc_sulfide_term_chem_know` (planning placeholder — not a live link)
