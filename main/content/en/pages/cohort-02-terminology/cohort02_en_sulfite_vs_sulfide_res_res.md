---
route_id: cohort02_en_sulfite_vs_sulfide_res_res
inventory_row_id: INV-C02-00896
status: draft
...
locale: en
source_language: en
title: Sulfite vs Sulfide — Difference Reference | bisulfid.com
...
---
# Sulfite vs Sulfide — Difference Reference
...
- Comparison intent: Sulfite vs Sulfide
...
| --- | --- | --- | --- |
| A | sulfite | source_required_unresolved | claim_pending_review |
...
- `route_id`: `cohort02_en_sulfite_term_chem_know` (planning placeholder — not a live link)
