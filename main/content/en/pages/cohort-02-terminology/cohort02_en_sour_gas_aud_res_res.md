---
route_id: cohort02_en_sour_gas_aud_res_res
inventory_row_id: INV-C02-00759
status: draft
...
locale: en
source_language: en
title: Sour Gas for Researchers | bisulfid.com
...
- Audience-layer explainer for `sour_gas` (Researchers)
...
- `route_id`: `cohort02_en_sour_gas_term_chem_know` (planning placeholder — not a live link)
