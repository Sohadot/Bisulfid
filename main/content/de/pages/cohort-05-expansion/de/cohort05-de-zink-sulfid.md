---
route_id: cohort05_de_zink_sulfid
status: draft
...
Kontrollierter **Terminologie-/Referenz-Eintrag** (`route_id`: `cohort05_de_zink_sulfid`) — keine Lehrbuch-, Blog-, Pilot- oder Glossar-Ersatzseite. Die Seite dient der **governed corpus expansion** innerhalb des festen **14.000-Seiten-Mindestziels**, nicht einem reduzierten Publikationsumfang.
...
Spätere Verlinkung per `route_id` `cohort05_de_zink_sulfid` — hier nur Planungsreferenz, keine Markdown-Links, keine Live-URLs.

*Nicht veröffentlichungsreifer Pipeline-Entwurf — COHORT_05_14000_LAUNCH_FOUNDATION — `cohort05_de_zink_sulfid`.*
